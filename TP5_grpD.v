...
(* Note: *)
(* lia fonctionne car il y a ~ x <= v2 et x <= v2 qui sont des inégalités contraire *)
(* discriminate fonctionne car on a introduit lol1 et lol2 qui sont des égalités contraire *)
...
all: try (cut (a0 = a1); [intros e; subst; reflexivity | lia ]). (* cas résolution 2 *) (* resout but courant avec ... tandis que lia referme la branche du x=y *) 
